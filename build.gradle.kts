...
pitest {
	...
	targetClasses.set(
		listOf(
			...
			"com.paymentservice.ledger.MerkleTree",
			"com.paymentservice.ledger.CanonicalLeafCodec",
			"com.paymentservice.ledger.AnchorChain",
			"com.paymentservice.ledger.AnchorLeafCsv",
	...
	targetTests.set(
		listOf(
			...
			"com.paymentservice.ledger.MerkleTreeTest",
			"com.paymentservice.ledger.CanonicalLeafCodecTest",
			"com.paymentservice.ledger.AnchorChainTest",
			"com.paymentservice.ledger.AnchorLeafCsvTest",
